...
describe('Service Tests', () => {
  describe('Document Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Document(0, 'AAAAAAA', currentDate, 'AAAAAAA', 'AAAAAAA', 'image/png', 'AAAAAAA', Status.ENABLED);
    });
    ...
    describe('Service methods', () => {
      it('should find an element', () => {
        const returnedFromService = Object.assign(
          {
            defenseDate: currentDate.format(DATE_FORMAT)
          },
          elemDefault
        );
        service
