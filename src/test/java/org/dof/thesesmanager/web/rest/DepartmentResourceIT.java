...
import org.dof.thesesmanager.domain.Department;
import org.dof.thesesmanager.repository.DepartmentRepository;
import org.dof.thesesmanager.service.DepartmentService;
import org.dof.thesesmanager.service.dto.DepartmentDTO;
import org.dof.thesesmanager.service.mapper.DepartmentMapper;
...
public class DepartmentResourceIT {
    ...
    private static final String DEFAULT_HOD_NAME = "AAAAAAAAAA";
    private static final String UPDATED_HOD_NAME = "BBBBBBBBBB";
    ...
    public void createDepartment() throws Exception {
        ...
        assertThat(testDepartment.getHodName()).isEqualTo(DEFAULT_HOD_NAME);
    ...
    public void getAllDepartments() throws Exception {
        ...
        restDepartmentMockMvc.perform(get("/api/departments?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].hodName").value(hasItem(DEFAULT_HOD_NAME)))
    ...
    public void getDepartment() throws Exception {
        ...
        restDepartmentMockMvc.perform(get("/api/departments/{id}", department.getId()))
            ...
            .andExpect(jsonPath("$.hodName").value(DEFAULT_HOD_NAME))
    ...
    public void updateDepartment() throws Exception {
        ...
        assertThat(testDepartment.getHodName()).isEqualTo(UPDATED_HOD_NAME);
